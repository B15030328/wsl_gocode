...
func CreateUser(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	if err := dbopts.AddUserCredential(ubody.Username, ubody.Pwd); err != nil {
...
func Login(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	pwd, err := dbopts.GetUserCredential(ubody.Username)
...
func AddNewVideo(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	vi, err := dbopts.AddNewVideo(nvbody.AuthorId, nvbody.Name)
...
func ListAllVideos(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	uname := p.ByName("username")
	vs, err := dbopts.ListVideoInfo(uname, 0, utils.GetCurrentTimestampSec())
	if err != nil {
...
func DeleteVideo(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	vid := p.ByName("vid-id")
	err := dbopts.DeleteVideoInfo(vid)
	if err != nil {
...
func PostComment(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	vid := p.ByName("vid-id")
	if err := dbopts.AddNewComments(vid, cbody.AuthorId, cbody.Content); err != nil {
...
func ShowComments(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	vid := p.ByName("vid-id")
	cm, err := dbopts.ListComments(vid, 0, utils.GetCurrentTimestampSec())
	if err != nil {
