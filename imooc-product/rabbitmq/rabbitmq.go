...
const MQURL = "amqp://chory:root@localhost:5672/prod"
...
//simple 模式下消费者
func (r *RabbitMQ) ConsumeSimple(orderService services.OrderService, productService services.IProductService) {
	//1.申请队列，如果队列不存在会自动创建，存在则跳过创建
